...
export class ArchiveComponent implements OnInit {
  public issuerData = ['Issuer 1', 'Issuer 2', 'Issuer 3'];
  public statusData = ['Issued', 'To Review', 'Completed', 'Cancelled'];
  public adminStatusData = ['Admin Issued', 'Admin To Review', 'Admin Completed', 'Admin Cancelled'];
  public assigneeData = ['Guy Hawkings', 'Marvin McKinney', 'Floyd Miles', 'Brooklyn Simmons', 'Jacob Jones', 'Devon Lane', 'Jenny Wilson'];
